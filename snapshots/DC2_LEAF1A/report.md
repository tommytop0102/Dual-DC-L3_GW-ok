...
Et1                            up             up                 P2P_LINK_TO_DC2_SPINE1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_DC2_SPINE2_Ethernet1
Et3                            up             up                 MLAG_PEER_DC2_LEAF1B_Ethernet3
Et4                            up             up                 MLAG_PEER_DC2_LEAF1B_Ethernet4
Et5                            up             up                 dc2-server01_Eth1
Et6                            up             up                 dc2-server02_Eth1
...
Po3                            up             up                 MLAG_PEER_DC2_LEAF1B_Po3
Po5                            up             up                 dc2-server01_PortChannel5
Po6                            up             up                 dc2-server02_PortChannel6
Vl120                          up             up                 VRF_RED_VLAN_120
Vl121                          up             up                 VRF_BLUE_VLAN_121
Vl1198                         up             up                 
Vl1199                         up             up                 
Vl4093                         up             up                 MLAG_PEER_L3_PEERING
Vl4094                         up             up                 MLAG_PEER
Vx1                            up             up                 DC2_LEAF1A_VTEP
```
...
--------------- ------------------- ---------- ------------- ---------- -------
Ethernet1       172.31.20.1/31      up         up               9214           
Ethernet2       172.31.20.3/31      up         up               9214           
Loopback0       10.255.20.3/32      up         up              65535           
Loopback1       10.255.21.3/32      up         up              65535           
Loopback110     10.255.110.3/32     up         up              65535           
Loopback210     10.255.210.3/32     up         up              65535           
Management0     192.168.4.23/24     up         up               1500           
...
Vlan4093        10.255.252.0/31     up         up               9214           
Vlan4094        10.255.251.0/31     up         up               9214
```
## show lldp neighbors

```
Last table change time   : 0:00:43 ago
...
---------- ------------------------ ---------------------- ---
Et1           DC2_SPINE1               Ethernet1           120
Et2           DC2_SPINE2               Ethernet1           120
Et3           DC2_LEAF1B               Ethernet3           120
Et4           DC2_LEAF1B               Ethernet4           120
Et5           dc2-client1              aac1.abff.e981      120
Et6           dc2-client2              aac1.ab2e.b984      120
...
interface Ethernet1
   ...
   mtu 9214
   no switchport
   ip address 172.31.20.1/31
!
interface Ethernet2
   description P2P_LINK_TO_DC2_SPINE2_Ethernet1
   mtu 9214
   no switchport
   ip address 172.31.20.3/31
!
interface Ethernet3
...
router bgp 65201
   ...
   neighbor 10.255.252.1 description DC2_LEAF1B
   neighbor 172.31.20.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.0 remote-as 65200
   neighbor 172.31.20.0 description DC2_SPINE1_Ethernet1
   neighbor 172.31.20.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.2 remote-as 65200
   neighbor 172.31.20.2 description DC2_SPINE2_Ethernet1
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 120
      rd 10.255.20.3:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 121
      rd 10.255.20.3:10121
...
Arista cEOSLab
Hardware version: 
Serial number: C02DE2B938E0B13F26AE82C40BBBA223
Hardware MAC address: 001c.73cf.87b2
System MAC address: 001c.73cf.87b2
