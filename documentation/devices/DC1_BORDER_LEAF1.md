...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.4.17/24 | 192.168.4.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAVES | Vlan4094 | 10.255.241.29 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1_BORDER_LEAF2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_DC1_BORDER_LEAF2_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE1_Ethernet5 | routed | - | 172.31.10.57/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE2_Ethernet5 | routed | - | 172.31.10.59/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_WAN_Ethernet1 | routed | - | 172.16.30.0/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1_BORDER_LEAF2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.10.17/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.11.17/32 |
| Loopback110 | RED_VTEP_DIAGNOSTICS | RED | 10.255.110.17/32 |
| Loopback210 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.210.17/32 |
...
| Vlan3109 |  RED  |  10.255.242.28/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3209 |  BLUE  |  10.255.242.28/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.242.28/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.241.28/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.242.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.16.30.1 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.56 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.58 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.242.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.242.29 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.255.10.17:10110 | 10110:10110<br>remote 10110:10110 | - | - | learned |
| 112 | 10.255.10.17:10112 | 10112:10112<br>remote 10112:10112 | - | - | learned |
| 120 | 10.255.10.17:10120 | 10120:10120<br>remote 10120:10120 | - | - | learned |
| 122 | 10.255.10.17:10122 | 10122:10122<br>remote 10122:10122 | - | - | learned |
| 211 | 10.255.10.17:10211 | 10211:10211<br>remote 10211:10211 | - | - | learned |
| 213 | 10.255.10.17:10213 | 10213:10213<br>remote 10213:10213 | - | - | learned |
| 221 | 10.255.10.17:10221 | 10221:10221<br>remote 10221:10221 | - | - | learned |
| 223 | 10.255.10.17:10223 | 10223:10223<br>remote 10223:10223 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.17:210 | connected |
| RED | 10.255.10.17:110 | connected |
...
router bgp 65103
   ...
   !
   vlan 110
      rd 10.255.10.17:10110
      rd evpn domain remote 10.255.10.17:10110
   ...
   !
   vlan 120
      rd 10.255.10.17:10120
      rd evpn domain remote 10.255.10.17:10120
      route-target both 10120:10120
      route-target import export evpn domain remote 10120:10120
      redistribute learned
   !
   vlan 122
      rd 10.255.10.17:10122
      rd evpn domain remote 10.255.10.17:10122
      route-target both 10122:10122
      route-target import export evpn domain remote 10122:10122
      redistribute learned
   !
   vlan 211
      rd 10.255.10.17:10211
      rd evpn domain remote 10.255.10.17:10211
   ...
   !
   vlan 221
      rd 10.255.10.17:10221
      rd evpn domain remote 10.255.10.17:10221
      route-target both 10221:10221
      route-target import export evpn domain remote 10221:10221
      redistribute learned
   !
   vlan 223
      rd 10.255.10.17:10223
      rd evpn domain remote 10.255.10.17:10223
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.210.17
