...
| Ethernet5 | dc1-server03_Eth1 | *access | *120 | *- | *- | 5 |
| Ethernet6 | dc1-server04_Eth1 | *trunk | *213 | *- | *- | 6 |
...
| Port-Channel5 | dc1-server03_PortChannel5 | switched | access | 120 | - | - | - | - | 5 | - |
| Port-Channel6 | dc1-server04_PortChannel6 | switched | trunk | 213 | - | - | - | - | 6 | - |
...
| Loopback220 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.220.15/32 |
...
| Vlan3219 |  BLUE  |  10.255.242.24/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 111 | 10.255.10.15:10111 | 10111:10111 | - | - | learned |
| 112 | 10.255.10.15:10112 | 10112:10112 | - | - | learned |
| 120 | 10.255.10.15:55120 | 55120:55120 | - | - | learned |
| 213 | 10.255.10.15:10213 | 10213:10213 | - | - | learned |
| 214 | 10.255.10.15:10214 | 10214:10214 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.15:220 | connected |
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.220.15
