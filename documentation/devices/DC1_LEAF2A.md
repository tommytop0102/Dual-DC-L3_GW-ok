...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.4.15/24 | 192.168.4.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.241.25 | Port-Channel3 |
...
| Ethernet5 | dc1-server03_Eth1 | *trunk | *112 | *- | *- | 5 |
| Ethernet6 | dc1-server04_Eth1 | *trunk | *113 | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE1_Ethernet3 | routed | - | 172.31.10.49/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE2_Ethernet3 | routed | - | 172.31.10.51/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.10.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.11.15/32 |
| Loopback110 | RED_VTEP_DIAGNOSTICS | RED | 10.255.110.15/32 |
| Loopback210 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.210.15/32 |
...
interface Loopback110
   ...
   no shutdown
   vrf RED
   ip address 10.255.110.15/32
!
interface Loopback210
   description BLUE_VTEP_DIAGNOSTICS
   no shutdown
   vrf BLUE
   ip address 10.255.210.15/32
```
...
| Vlan3109 |  RED  |  10.255.242.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3209 |  BLUE  |  10.255.242.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.242.24/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.241.24/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.242.25 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.10.48 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.50 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.242.25 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.242.25 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.255.10.15:10110 | 10110:10110 | - | - | learned |
| 112 | 10.255.10.15:10112 | 10112:10112 | - | - | learned |
| 120 | 10.255.10.15:10120 | 10120:10120 | - | - | learned |
| 122 | 10.255.10.15:10122 | 10122:10122 | - | - | learned |
| 211 | 10.255.10.15:10211 | 10211:10211 | - | - | learned |
| 213 | 10.255.10.15:10213 | 10213:10213 | - | - | learned |
| 221 | 10.255.10.15:10221 | 10221:10221 | - | - | learned |
| 223 | 10.255.10.15:10223 | 10223:10223 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.15:210 | connected |
| RED | 10.255.10.15:110 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.242.25 description DC1_LEAF2B
   neighbor 172.31.10.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.48 remote-as 65100
   neighbor 172.31.10.48 description DC1_SPINE1_Ethernet3
   neighbor 172.31.10.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.50 remote-as 65100
   neighbor 172.31.10.50 description DC1_SPINE2_Ethernet3
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 10.255.10.15:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 112
      rd 10.255.10.15:10112
      route-target both 10112:10112
      redistribute learned
   !
   vlan 120
      rd 10.255.10.15:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 122
      rd 10.255.10.15:10122
      route-target both 10122:10122
      redistribute learned
   !
   vlan 211
      rd 10.255.10.15:10211
      route-target both 10211:10211
      redistribute learned
   !
   vlan 213
      rd 10.255.10.15:10213
      route-target both 10213:10213
      redistribute learned
   !
   vlan 221
      rd 10.255.10.15:10221
      route-target both 10221:10221
      redistribute learned
   !
   vlan 223
      rd 10.255.10.15:10223
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.210.15
ip address virtual source-nat vrf RED address 10.255.110.15
```
