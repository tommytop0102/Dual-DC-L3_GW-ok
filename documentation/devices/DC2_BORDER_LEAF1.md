...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2_SPINE1_Ethernet5 | routed | - | 172.31.20.17/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2_SPINE2_Ethernet5 | routed | - | 172.31.20.19/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_WAN_Ethernet3 | routed | - | 172.31.30.4/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.20.7/32 |
...
| 172.31.20.16 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.20.18 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.30.5 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| BLUE | 10.255.20.7:210 | connected |
| RED | 10.255.20.7:110 | connected |
...
router bgp 65203
   ...
   neighbor 10.255.252.9 description DC2_BORDER_LEAF2
   neighbor 172.31.20.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.16 remote-as 65200
   neighbor 172.31.20.16 description DC2_SPINE1_Ethernet5
   neighbor 172.31.20.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.20.18 remote-as 65200
   neighbor 172.31.20.18 description DC2_SPINE2_Ethernet5
   neighbor 172.31.30.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.30.5 remote-as 65300
   neighbor 172.31.30.5 description WAN_Ethernet3
