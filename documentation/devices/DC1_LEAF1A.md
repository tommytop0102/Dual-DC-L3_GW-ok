...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.241.1 | Port-Channel3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE1_Ethernet1 | routed | - | 172.31.10.1/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE2_Ethernet1 | routed | - | 172.31.10.3/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.10.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.11.3/32 |
| Loopback110 | RED_VTEP_DIAGNOSTICS | RED | 10.255.110.3/32 |
| Loopback210 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.210.3/32 |
...
| Vlan4093 |  default  |  10.255.242.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.241.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.242.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.10.0 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.2 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.255.10.3:10110 | 10110:10110 | - | - | learned |
| 111 | 10.255.10.3:10111 | 10111:10111 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.3:210 | connected |
| RED | 10.255.10.3:110 | connected |
...
router bgp 65101
   ...
   neighbor 10.255.242.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.242.1 description DC1_LEAF1B
   neighbor 172.31.10.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.0 remote-as 65100
   neighbor 172.31.10.0 description DC1_SPINE1_Ethernet1
   neighbor 172.31.10.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.2 remote-as 65100
   neighbor 172.31.10.2 description DC1_SPINE2_Ethernet1
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 10.255.10.3:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 10.255.10.3:10111
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.210.3
ip address virtual source-nat vrf RED address 10.255.110.3
```
