...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.241.4 | Port-Channel3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE1_Ethernet4 | routed | - | 172.31.10.13/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE2_Ethernet4 | routed | - | 172.31.10.15/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.10.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.11.5/32 |
| Loopback110 | RED_VTEP_DIAGNOSTICS | RED | 10.255.110.6/32 |
| Loopback210 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.210.6/32 |
...
| Vlan4093 |  default  |  10.255.242.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.241.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.242.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.31.10.12 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.14 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 112 | 10.255.10.6:10112 | 10112:10112 | - | - | learned |
| 113 | 10.255.10.6:10113 | 10113:10113 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.6:210 | connected |
| RED | 10.255.10.6:110 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.242.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.242.4 description DC1_LEAF2A
   neighbor 172.31.10.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.12 remote-as 65100
   neighbor 172.31.10.12 description DC1_SPINE1_Ethernet4
   neighbor 172.31.10.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.14 remote-as 65100
   neighbor 172.31.10.14 description DC1_SPINE2_Ethernet4
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 112
      rd 10.255.10.6:10112
      route-target both 10112:10112
      redistribute learned
   !
   vlan 113
      rd 10.255.10.6:10113
