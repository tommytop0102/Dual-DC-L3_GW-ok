...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.4.18/24 | 192.168.4.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAVES | Vlan4094 | 10.255.241.28 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC1_BORDER_LEAF1_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_DC1_BORDER_LEAF1_Ethernet4 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1_SPINE1_Ethernet6 | routed | - | 172.31.10.61/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1_SPINE2_Ethernet6 | routed | - | 172.31.10.63/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_WAN_Ethernet2 | routed | - | 172.16.30.2/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC1_BORDER_LEAF1_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.10.18/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.11.17/32 |
| Loopback110 | RED_VTEP_DIAGNOSTICS | RED | 10.255.110.18/32 |
| Loopback210 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.255.210.18/32 |
...
interface Loopback110
   ...
   no shutdown
   vrf RED
   ip address 10.255.110.18/32
!
interface Loopback210
   description BLUE_VTEP_DIAGNOSTICS
   no shutdown
   vrf BLUE
   ip address 10.255.210.18/32
```
...
| Vlan3109 |  RED  |  10.255.242.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3209 |  BLUE  |  10.255.242.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.242.29/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.241.29/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.20.27 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
| 10.255.20.28 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
| 10.255.242.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.16.30.3 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.60 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.31.10.62 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.242.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.242.28 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.255.10.18:10110 | 10110:10110<br>remote 10110:10110 | - | - | learned |
| 112 | 10.255.10.18:10112 | 10112:10112<br>remote 10112:10112 | - | - | learned |
| 120 | 10.255.10.18:10120 | 10120:10120<br>remote 10120:10120 | - | - | learned |
| 122 | 10.255.10.18:10122 | 10122:10122<br>remote 10122:10122 | - | - | learned |
| 211 | 10.255.10.18:10211 | 10211:10211<br>remote 10211:10211 | - | - | learned |
| 213 | 10.255.10.18:10213 | 10213:10213<br>remote 10213:10213 | - | - | learned |
| 221 | 10.255.10.18:10221 | 10221:10221<br>remote 10221:10221 | - | - | learned |
| 223 | 10.255.10.18:10223 | 10223:10223<br>remote 10223:10223 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.255.10.18:210 | connected |
| RED | 10.255.10.18:110 | connected |
...
router bgp 65103
   ...
   neighbor 10.255.242.28 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.242.28 description DC1_BORDER_LEAF1
   neighbor 172.16.30.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.30.3 remote-as 65300
   neighbor 172.16.30.3 description WAN
   neighbor 172.31.10.60 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.60 remote-as 65100
   neighbor 172.31.10.60 description DC1_SPINE1_Ethernet6
   neighbor 172.31.10.62 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.10.62 remote-as 65100
   neighbor 172.31.10.62 description DC1_SPINE2_Ethernet6
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 10.255.10.18:10110
      rd evpn domain remote 10.255.10.18:10110
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.255.210.18
ip address virtual source-nat vrf RED address 10.255.110.18
```
